...
export function JointIcon({ dark }){
  ...
  return <svg
            className="transform scale-90 translate-x-8 -translate-y-6 lg:-translate-y-12 overflow-visible "
            width={100}
            height={100}
            fill="none"
            viewBox="0 0 100 100"
          >
              <circle cx="25" cy="50" r="60" fill={dark? "#31a354":"white"} opacity="0.1" className=""/>
              <circle cx="25" cy="50" r="80" fill={dark? "#31a354":"white"} opacity="0.1" className=""/>
              <circle cx="32" cy="50" r="80" fill={dark? "#31a354":"white"} opacity="0.1" className="animate-ping-slow origin-center"/>

              <circle cx="10" cy="20" r="6"  fill="yellow" className="animate-ping-slow origin-right "/>
              <circle cx="60" cy="50" r="6"  fill="yellow" className="animate-ping-xxslow origin-left "/>
              <circle cx="10" cy="80" r="6"  fill="yellow" className="animate-ping-xslow origin-right "/>
