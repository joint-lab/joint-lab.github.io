...
function AlumniThumbnail({ firstName, lastName, role, imageUrl, slug, githubURL, personalURL, scholarURL, twitterURL, email, lab}){
  return <li className="px-2 py-2 hover:bg-gray-100 rounded xl:text-left space-y-4 justify-start justify-items-start">
            <Link to={slug}>
              <div className="text-lg leading-6 font-medium space-y-1">
                <h3>{firstName} {lastName}</h3>
