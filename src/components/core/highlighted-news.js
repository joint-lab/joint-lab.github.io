...
export function HighlightedNews({ title, date, excerpt, slug, imgSrc, className }){
  return  <div className={classnames('bg-gradient-to-r from-gray-100 to-gray-200 text-gray-800 shadow hover:bg-indigo-900 px-3 py-3 lg:px-6 lg:py-6 rounded h-full flex items-end', className)}>
              <Link to={slug}>
