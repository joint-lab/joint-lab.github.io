...
- Requires Node.js 18+ (20 LTS recommended — see `.nvmrc`).
...
2. Make sure you have Node.js 18+ installed (`nvm use` if you use nvm).
...
1. Then you can visit `http://localhost:8000/` in a browser and should be viewing the latest version of the development website.
